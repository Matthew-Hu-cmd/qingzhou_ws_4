				...
				while Video.isOpened():
					...
					if ret is None:
						...
						if shift:     # PID控制角度
							...
							now_angle = Kp * now_err + Kd * (D_error[0]*0.6+D_error[1]*0.3+D_error[2]*0.1)
						else:
							out_check += 1
						
						if -now_angle>angle and angle > 18:
							now_angle=now_angle*0.5
						elif -now_angle < angle and angle < 0:
							now_angle = now_angle*0.6
